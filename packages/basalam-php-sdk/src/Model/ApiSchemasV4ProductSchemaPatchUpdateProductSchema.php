<?php
/**
 * ApiSchemasV4ProductSchemaPatchUpdateProductSchema
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ApiSchemasV4ProductSchemaPatchUpdateProductSchema Class Doc Comment
 *
 * @category Class
 * @package  BasalamSDK
 * @author   OpenAPI Generator team
 ...
 */
class ApiSchemasV4ProductSchemaPatchUpdateProductSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api__schemas__v4__product_schema__PatchUpdateProductSchema';
    ...
    */
     ...
     * Sets package_weight
     *
     * @param int|null $package_weight package_weight
     *
     * @return self
     */
    public function setPackageWeight($package_weight)
    {
        if (is_null($package_weight)) {
            array_push($this->openAPINullablesSetToNull, 'package_weight');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('package_weight', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
