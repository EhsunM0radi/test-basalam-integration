...
/**
 * PhotoResponse Class Doc Comment
 *
 * @category Class
 * @package  BasalamSDK
 * @author   OpenAPI Generator team
 ...
 */
class PhotoResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhotoResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('xs', $data ?? [], null);
        $this->setIfExists('sm', $data ?? [], null);
        $this->setIfExists('md', $data ?? [], null);
        $this->setIfExists('lg', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['sm'] === null) {
            $invalidProperties[] = "'sm' can't be null";
        }
        if ($this->container['md'] === null) {
            $invalidProperties[] = "'md' can't be null";
        }
        if ($this->container['lg'] === null) {
            $invalidProperties[] = "'lg' can't be null";
        }
    ...
    {
        if (is_null($xs)) {
            throw new \InvalidArgumentException('non-nullable xs cannot be null');
        }
    ...
    {
        if (is_null($lg)) {
            throw new \InvalidArgumentException('non-nullable lg cannot be null');
        }
