<?php
/**
 * ApiSchemasV4ProductSchemaProductVariants
 *
 * PHP version 8.1
 *
 * @category Class
...
/**
 * ApiSchemasV4ProductSchemaProductVariants Class Doc Comment
 *
 * @category Class
 * @package  BasalamSDK
 * @author   OpenAPI Generator team
 ...
 */
class ApiSchemasV4ProductSchemaProductVariants implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'api__schemas__v4__product_schema__ProductVariants';
    ...
    protected static $openAPITypes = [
        ...
        'stock' => 'int',
        'sku' => 'string',
        'properties' => '\BasalamSDK\Model\ApiSchemasV4ProductSchemaPropertyVariant[]'
    ];
    ...
    */
    ...
    public function setPrimaryPrice($primary_price)
    {
        if (is_null($primary_price)) {
            throw new \InvalidArgumentException('non-nullable primary_price cannot be null');
        }
     ...
     * Gets properties
     *
     * @return \BasalamSDK\Model\ApiSchemasV4ProductSchemaPropertyVariant[]
     */
     ...
     * Sets properties
     *
     * @param \BasalamSDK\Model\ApiSchemasV4ProductSchemaPropertyVariant[] $properties properties
     *
     * @return self
     */
