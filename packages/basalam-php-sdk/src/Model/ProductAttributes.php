 ...
 */
class ProductAttributes implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ProductAttributes';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['selected_values']) && (count($this->container['selected_values']) < 1)) {
            $invalidProperties[] = "invalid value for 'selected_values', number of items must be greater than or equal to 1.";
        }
     ...
     *
     * @param int[]|null $selected_values selected_values
     *
     * @return self
     */
    public function setSelectedValues($selected_values)
    {
        if (is_null($selected_values)) {
            array_push($this->openAPINullablesSetToNull, 'selected_values');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('selected_values', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        if (!is_null($selected_values) && (count($selected_values) < 1)) {
            throw new \InvalidArgumentException('invalid length for $selected_values when calling ProductAttributes., number of items must be greater than or equal to 1.');
        }
